...
def network_graph(K, newData):
    ...
    nx.set_node_attributes(G, newData.set_index('Artist')['Instrument'].to_dict(), 'Instrument')
    nx.set_node_attributes(G, newData.set_index('Artist')['Artist Notes'].to_dict(), 'Artist Notes')
    nx.set_node_attributes(G, newData.set_index('Album')['Album Notes'].to_dict(), 'Album Notes') 
